...
choose_file = {
    ...
    'steps': ({'description': _(u'Provide a [Title] (i.e. \\"My File.\\")'),
               ...
               {'description': _(u"Click the Browse button of the [File field]."),
               'idStep': u'',
...
insert_internal_link = {
    ...
    'steps': ({'description': _(u"Type some link text in the [Body Text] field of the page (i.e. Download this report)."),
               ...
               {'description': _(u"Now highlight the link text and click the [Link icon] in the editor toolbar (it looks like a piece of chain link)."),
               ...
               'selector': u'#internallinkcontainer input[value$=\/myfolder\/my\-file]',
               'text': u''},
